...
@section('content')
    @if($current_round['id'] > 4)
        <div class="alert alert-info">AirDrop has ended, please check the <a href="{{ route('dashboard.results') }}">results page</a>.<br><br>Amount Distribution date is <strong>19th December 2021</strong> (if you have won).
    @else
